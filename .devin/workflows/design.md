---
description: Guide visual screen design (via external tools or in-editor interactive prototyping), record the conversation in design-chat.md, reconcile conflicts with written specs, and close Day One
---
...
چطور پیش رفتی؟
۱. طرح را با یک ابزارِ طراحیِ خارجی (Claude on the web بخش Design، Google Stitch، v0، Lovable، Figma و...) انجام دادم و در پوشهٔ UI/ گذاشتم
۲. طرح را با ابزار دیگری انجام دادم و در پوشهٔ UI/ گذاشتم
